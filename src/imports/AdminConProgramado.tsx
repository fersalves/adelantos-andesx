...
function Frame({ isOn, onToggle, onAdelantarClick, customText, onModificarClick }: { isOn: boolean; onToggle: () => void; onAdelantarClick?: () => void; customText?: string; onModificarClick?: () => void }) {
  return (
