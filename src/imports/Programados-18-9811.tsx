import svgPaths from "./svg-xc709tu3pp";
...
function Frequencia() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="frequencia">
      <Frame1 />
      <Frame />
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[#d0d4e6] h-[48px] max-h-[48px] min-h-[48px] relative rounded-[12px] shrink-0 w-full" data-name="Button">
...
// Export apenas a parte dos seletores de dias da semana
export function SeletoresDiasDaSemana() {
  return (
