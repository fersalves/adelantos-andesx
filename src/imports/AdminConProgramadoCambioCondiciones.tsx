...
function Frame({ onAdelantarClick, customText, onRevisarCostoClick }: { onAdelantarClick?: () => void; customText?: string; onRevisarCostoClick?: () => void }) {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full">
      <div className="content-stretch flex flex-col gap-[48px] items-start px-[16px] py-0 relative size-full">
        ...
        <div className="shrink-0 w-[328px]">
          <ProgramadoCambioCondiciones 
            customText={customText} 
            onRevisarCostoClick={onRevisarCostoClick}
          />
        </div>
        <Cross />
      </div>
...
export default function AdminConProgramadoCambioCondiciones({ 
  onAdelantarClick, 
  customText, 
  onRevisarCostoClick,
}: { 
  ...
  return (
    <div className="bg-white relative rounded-[16px] size-full" data-name="Admin">
      <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip pb-[24px] pt-0 px-0 relative rounded-[inherit] size-full">
        <Frame1 />
        <Frame onAdelantarClick={onAdelantarClick} customText={customText} onRevisarCostoClick={onRevisarCostoClick} />
      </div>
