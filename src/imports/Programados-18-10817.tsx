import svgPaths from "./svg-9qmo95f8ux";
...
// Export para seletores de dias com dia selecionado
export function SeletoresDiasComCard({ selectedDay, onDayClick }: { selectedDay?: string; onDayClick?: (day: string) => void }) {
