...
function Frame4({ isOn, onToggle }: { isOn: boolean; onToggle: () => void }) {
  return (
...
function Frame6({ isOn, onToggle }: { isOn: boolean; onToggle: () => void }) {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
      <Frame4 isOn={isOn} onToggle={onToggle} />
      <Textlink1 />
    </div>
  );
}

function Card({ isOn, onToggle }: { isOn: boolean; onToggle: () => void }) {
  return (
    <div className="bg-white relative rounded-[20px] shrink-0 w-[328px]" data-name="Card">
      <div className="content-stretch flex gap-[16px] items-start overflow-clip p-[16px] relative rounded-[inherit] w-full">
        <Thumbnail />
        <Frame6 isOn={isOn} onToggle={onToggle} />
      </div>
...
function Frame({ isOn, onToggle, customText, onModificarClick, onPorQueClick }: { isOn: boolean; onToggle: () => void; customText?: string; onModificarClick?: () => void; onPorQueClick?: () => void }) {
  return (
...
export default function AdminSinAdelantarConProgramado({
  customText,
  onModificarClick,
  isToggleOn = true,
  onToggleChange,
  ...
  return (
    <div className="bg-white relative rounded-[16px] size-full" data-name="Admin">
      <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip pb-[24px] pt-0 px-0 relative rounded-[inherit] size-full">
        <Frame1 />
        <Frame isOn={localToggleState} onToggle={handleToggle} customText={customText} onModificarClick={onModificarClick} onPorQueClick={onPorQueClick} />
        <Snackbar 
