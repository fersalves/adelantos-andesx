...
export default function AdminPartially({ onAdelantarClick, onProgramarClick, totalDisponible }: { onAdelantarClick?: () => void; onProgramarClick?: () => void; totalDisponible?: number }) {
