    ...
    <div className="relative shrink-0 size-[16px]" data-name="Recurring payments">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Recurring payments">
          <g id="Vector">
            <path d={svgPaths.p32474a00} fill="var(--fill-0, #282834)" />
            <path d={svgPaths.p22763600} fill="var(--fill-0, #282834)" />
            <path d={svgPaths.p1985d600} fill="var(--fill-0, #282834)" />
          </g>
        </g>
      </svg>
    </div>
...
function MainContent() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start min-h-px min-w-px relative" data-name="Main content">
      <TitleRow />
    </div>
  );
}
...
function Content1() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-start px-0 py-[12px] relative rounded-[8px] shrink-0 w-full" data-name="Content">
      <PaddingLeft />
      <Row />
      <PaddingRight />
    </div>
...
function Card({ onClick }: { onClick?: () => void }) {
  return (
    <div
      onClick={onClick}
      className="bg-white relative rounded-[20px] shrink-0 w-full cursor-pointer"
      data-name="Card"
    >
...
function Programado({ onClick }: { onClick?: () => void }) {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="cross">
...
function Frame({ onInfoClick, onAdelantarClick, onProgramarClick }: { onInfoClick: () => void; onAdelantarClick?: () => void; onProgramarClick?: () => void }) {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full">
      <div className="content-stretch flex flex-col gap-[48px] items-start px-[16px] py-0 relative size-full">
        ...
        <Programado onClick={onProgramarClick} />
        <Cross />
      </div>
    </div>
  );
...
export default function AdminPartially({ onAdelantarClick, onProgramarClick }: { onAdelantarClick?: () => void; onProgramarClick?: () => void }) {
  ...
  return (
    <div className="bg-white relative rounded-[16px] size-full" data-name="Admin">
      <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip pb-[24px] pt-0 px-0 relative rounded-[inherit] size-full">
        <Frame1 />
        <Frame onInfoClick={handleInfoClick} onAdelantarClick={onAdelantarClick} onProgramarClick={onProgramarClick} />
        {showPopover && (
