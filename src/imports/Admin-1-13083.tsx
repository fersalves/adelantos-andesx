import svgPaths from "./svg-qh0i2eqadt";
...
function IconButton2() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center justify-center max-h-[40px] min-h-[40px] px-0 py-[2px] relative rounded-[12px] shrink-0 size-[40px]" data-name="Icon button">
      <Info />
    </div>
  );
}
...
function Popover() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[22px] shadow-[0px_0px_12px_0px_rgba(40,40,52,0.1)] top-[224px] w-[243px]" data-name="Popover">
      <Tip2 />
      <Surface />
    </div>
  );
